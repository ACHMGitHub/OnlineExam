...
<form class="form" role="form" id="signupForm">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" id="tch_name" name="username" placeholder="请输入姓名" value="${sessionScope.currentUser.name}">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" id="tch_pwd" name="password" value="${sessionScope.currentUser.pw}">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" id="tch_card" name="IDcard" value="${sessionScope.currentUser.card}">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" id="tch_title" placeholder="请输入职称" name="tchtitle" value="${sessionScope.currentUser.title}">
        </div>
    </div>
