    ...
    <div class="row clearfix">
        <div class="col-md-12 column">
            <table class="table table-hover">
                ...
                <c:forEach items="${choices}" var="u">
                    <tr>
                        ...
                        <td>
                            <c:if test="${u.analyse.length() > 8}">${fn:substring(u.analyse, 0, 8)}... ...</c:if>
                            <c:if test="${u.analyse.length() <= 8}">${u.analyse}</c:if>
                        </td>
            ...
            <div class="page_index">
                <ul class="pagination " >
                    <li>
                        <a href="/adminPage/choiceInfoByPage/1"><<</a>
                    </li>
                    <c:forEach var="i" begin="1" end="${num}" step="1">
                        <li>
                            <a href="/adminPage/choiceInfoByPage/${i}">${i}</a>
                        </li>
                    </c:forEach>
                    <li>
                        <a href="/adminPage/choiceInfoByPage/${num}">>></a>
                    </li>
                </ul>
            </div>
        </div>
